...
def add_access(filename="montreal_routes.json"):
    ...
    access_cols = [
        "point_id", "arrondissement", "heat_class", "heat_label",
        "total_feature", "collisions_n", "collisions_vic", "collisions_m",
        "collisions_bl", "collisions_gr", "permis_n", "permis_loger",
        "permis_types", "entraves_n", "entraves_act", "entraves_rai",
        "entraves_fin", "arbres_n", "arbres_especes_top", "arbres_dhp",
